...
const scrollerItems: ScrollerItem[] = [
  ...
  {
    "id": 58,
    "text": "Her var et gammelt møllested. Myrens mekaniske verksted er anlagt 1854.  I bakgrunnen Bentse bro.",
    "geopoint": {
  ...
  {
    "id": 70,
    "text": "Våghalsen Barkestampe - opført omkring 1800. I bakgrunnen Vøien. Knud Graahs tidligere bomullsspinneri anlagt i 1846.",
    "geopoint": {
  ...
  {
    "id": 81,
    "text": "Gamle Aker kirke og Telthusgaten. Telthusgaten har sitt navn efter en militær magasinbygning, et såkalt telthus som blev opført i 1700-årene.",
    "geopoint": {
  ...
  {
    "id": 111,
    "text": "Smalgangen - er den gamle forstadsgate som lengst har beholdt sitt preg fra 16 - 1700-årene. Takkammeret til venstre var for en tid Olafia Johansdottirs redningshjem.",
    "geopoint": {
