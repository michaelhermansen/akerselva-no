      ...
      <div ref={ref} className="block gap-8 text-white md:flex">
        ...
        <div
          className={classNames(
            "fixed bottom-6 right-6 z-50 h-[220px] w-3/4 flex-1 overflow-hidden rounded-sm bg-gray-medium shadow-2xl transition-opacity sm:h-[250px] sm:w-2/3 md:hidden",
